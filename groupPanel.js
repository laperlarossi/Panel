/*
[Script]
groupPanel = type=generic,timeout=10,script-path=https://raw.githubusercontent.com/laperlarossi/Panel/main/groupPanel.js,argument=icon=network&color=#86abee&group=Master
  对应参数：
	icon：图标
	color：图标颜色
	group：策略组名称
